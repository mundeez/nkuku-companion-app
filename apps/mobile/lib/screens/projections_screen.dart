...
class _ProjectionsScreenState extends State<ProjectionsScreen> {
  ...
  Future<void> _loadSuppliers() async {
    try {
      ...
      setState(() {
        _suppliers =
            (res.data as List).map((e) => Supplier.fromJson(e)).toList();
        _selectedSupplier = _suppliers.firstWhere((s) => s.isDefault,
  ...
  Future<void> _calculate() async {
    ...
    try {
      final res =
          await ApiService.dio.post('/api/v1/projections/calculate', data: {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Bird Count'),
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                          labelText: 'Sale Price per Bird (ZMW)'),
                      keyboardType: TextInputType.number,
                    ),
            ...
            const SizedBox(height: 16),
            const AdSlot(page: 'projections'),
            if (_projection != null) ...[
              const SizedBox(height: 16),
              _KpiCard(
                  title: 'Total Expenses',
                  value: 'ZMW ${_projection!.totalExpenses}',
                  color: Colors.red),
              _KpiCard(
                  title: 'Projected Revenue',
                  value: 'ZMW ${_projection!.projectedRevenue}',
                  color: Colors.blue),
              _KpiCard(
                  title: 'Gross Profit',
                  value: 'ZMW ${_projection!.grossProfit}',
                  color: Colors.green),
              _KpiCard(
                  title: 'Net Profit',
                  value: 'ZMW ${_projection!.netProfit}',
                  color: Colors.teal),
              const SizedBox(height: 16),
                      ...
                      bottomTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            if (idx >= 0 &&
                                idx < _projection!.breakdown.length) {
                              return Padding(
                                padding: const EdgeInsets.only(top: 4),
                                child: Text(
                                  _projection!.breakdown[idx].stageName
                                      .split(' ')
                                      .first,
              ...
              ..._projection!.breakdown.map((b) => ListTile(
                    ...
                    subtitle: Text(
                        '${b.itemsRoundedUp} items @ ZMW ${b.unitPriceZmw}',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis),
                    trailing: Text('ZMW ${b.subtotalZmw}',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
